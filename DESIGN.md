...
- **Navy — primario (`#1A4293` / dark `#3E6BC9`):** acciones primarias, navegación activa, texto de marca. Hover: `--navy-deep` (`#0E2C6B` / `#5B85DB`).
...
- **Semánticos:** ok verde (`#1E7B4F`), advertencia ámbar (`#8A6116`), cada uno con su fondo suave (`--ok-bg`, `--warn-bg`, `--danger-bg`).
...
- Agente IA usa violeta `#7A4FB0` solo como etiqueta de tipo.
