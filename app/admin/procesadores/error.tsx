 ...
 */
export default function ErrorProcesadores({ reset }: { error: Error; reset: () => void }) {
  return (
    <main className={styles.main}>
      <ErrorState
        title="No pudimos cargar el catálogo de procesadores"
        description="Hubo un problema al leer los procesadores. Intenta de nuevo; si sigue ocurriendo, avisa al Área de Innovación."
        onRetry={reset}
      />
    </main>
  );
